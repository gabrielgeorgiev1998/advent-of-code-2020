...
def check_valid(pswd):
  low_pat = "^[0-9]+-"
  high_pat = "-[0-9]+ "
  char_pat = " [a-z]:"
  ps_pat = ": [a-z]+$"

  pos1 = int(re.findall(low_pat, pswd)[0][:-1])
  pos2 = int(re.findall(high_pat, pswd)[0][1:])
  char = re.findall(char_pat, pswd)[0][1]
  ps = re.findall(ps_pat, pswd)[0][2:]
  ...
  pos1flag = char == pos1char
  pos2flag = char == pos2char
